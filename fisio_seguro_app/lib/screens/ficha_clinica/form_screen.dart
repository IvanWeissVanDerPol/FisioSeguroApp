...
class FichaClinicaFormScreen extends StatefulWidget {
  const FichaClinicaFormScreen({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _FichaClinicaFormScreen createState() => _FichaClinicaFormScreen();
}

class _FichaClinicaFormScreen extends State<FichaClinicaFormScreen> {
